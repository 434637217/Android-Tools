...
public final class AppTool {
    ...
    public int getAppVersionCode(Context ctx) {
        ...
        try {
            ...
            TBTools.log().tag(TAG).d("getAppVersionCodeFromPackage Exception ->: " + e.getMessage());
        }
        return -1;
    }
    ...
    public String getVersionNameFromPackage(Context context){
        try {
            ...
            TBTools.log().tag(TAG).d("getVersionNameFromPackage Exception ->: " + e.getMessage());
        }
        return null;
    }
    ...
    public boolean isAppForeground(Context context, String packageName) {
        return !TBTools.string().isEmpty(packageName) && packageName.equals(TBTools.process().getForegroundProcessName());
    }
    ...
    public void launchActivity(Context context, String packageName, String className, Bundle bundle) {
        context.startActivity(TBTools.intent().getComponentIntent(packageName, className, bundle));
    }
