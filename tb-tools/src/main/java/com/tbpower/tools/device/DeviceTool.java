package com.tbpower.tools.device;
...
public final class DeviceTool {
    ...
    public String getIMEI(Context context) {
        ...
        if (TBTools.string().isEmpty(imei)) {
            imei = "";
        }
    ...
    public String getUDID(Context context) {
        ...
        if (TBTools.string().isEmpty(udid) || udid.equals("9774d56d682e549c")
                || udid.length() < 15) {
            SecureRandom random = new SecureRandom();
            udid = new BigInteger(64, random).toString(16);
        }

        if (TBTools.string().isEmpty(udid)) {
            udid = "";
        }
    ...
    public String getLatestCameraPicture(Context context) {
        ...
        if (!TBTools.externalStorage().isAvailable()) {
            return null;
        }
    ...
    public float getScreenDensity() {
        return TBTools.app().getResources().getDisplayMetrics().density;
    }

    public int getScreenHeight() {
        return TBTools.app().getResources().getDisplayMetrics().heightPixels;
    }

    public int getScreenWidth() {
        return TBTools.app().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public String getIMEI() {
        TelephonyManager tm = (TelephonyManager) TBTools.app().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) TBTools.app()
                .getSystemService(Context.TELEPHONY_SERVICE);
        String str = "";
    ...
    public void dial(String phoneNumber) {
        ...
        TBTools.app().startActivity(intent);
    }
    ...
    public void sendSms(String phoneNumber, String content) {
        Uri uri = Uri.parse("smsto:" + (TBTools.string().isEmpty(phoneNumber) ? "" : phoneNumber));
        Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
        intent.putExtra("sms_body", TBTools.string().isEmpty(content) ? "" : content);
        TBTools.app().startActivity(intent);
    }
    ...
    public void sendSmsSilent(String phoneNumber, String content) {
        if (TBTools.string().isEmpty(content)) return;
        PendingIntent sentIntent = PendingIntent.getBroadcast(TBTools.app(), 0, new Intent(), 0);
    ...
    public List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = TBTools.app().getContentResolver();
        ...
        while (cursor.moveToNext()) {
            ...
            // 判断contact_id是否为空
            if (!TBTools.string().isEmpty(contact_id)) {//null   ""
