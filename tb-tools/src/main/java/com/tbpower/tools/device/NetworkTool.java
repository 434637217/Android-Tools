...
public final class NetworkTool {
    ...
    public void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            TBTools.app().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            TBTools.app().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) TBTools.app()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
